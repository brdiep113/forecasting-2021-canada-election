...
poststrat_data <- merge(poststrat_data, custom_code, by=c("Riding"))
poststrat_data <- merge(poststrat_data, province_data, by=c("custom_code"))
...
setdiff(poststrat_data$custom_code, custom_code)
